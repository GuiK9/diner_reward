...
public class AccountControllerBootTests {
	...
	public void createAccount() throws Exception {
		Account carlJungAccount = new Account("22322", "carl jung");
		carlJungAccount.setEntityId(21L);


		given(accountManager.save(carlJungAccount))
				.willReturn(carlJungAccount);

		String json = new ObjectMapper().writeValueAsString(carlJungAccount);
